...
<head>
    ...
    <style>
        ...
        @keyframes orbit {
            ...
            33% { transform: translate(100px, 100px) scale(1.2) rotate(120deg); }
...
<body class="relative flex items-center justify-center h-screen text-gray-800">
    ...
    <div class="absolute inset-0 overflow-hidden -z-10">
        ...
        <div class="bubble w-[400px] h-[400px] bg-purple-300/30 bottom-[5%] right-[-5%]" style="animation-duration: 30s; animation-delay: -5s;"></div>
        <div class="bubble w-[300px] h-[300px] bg-pink-200/40 top-[20%] right-[15%]" style="animation-duration: 20s; animation-delay: -2s;"></div>
        <div class="bubble w-[450px] h-[450px] bg-emerald-100/50 bottom-[-10%] left-[10%]" style="animation-duration: 35s;"></div>
    ...
    <div class="relative max-w-lg px-6 text-center">
        ...
        <div class="flex justify-center mb-6">
            <div class="inline-flex items-center gap-2 px-3 py-1 border border-blue-100 rounded-full shadow-sm badge-anim bg-white/60 backdrop-blur-md">
